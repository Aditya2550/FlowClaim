...
export const FX_RATES = {
  USD: 1, EUR: 0.92, GBP: 0.79, INR: 83.12, JPY: 149.5, CAD: 1.36, AUD: 1.53,
};
...
export const CATEGORIES = [
  ...
  { id: 'accommodation', label: 'Accommodation', icon: 'Building', color: '#F97316' },
  { id: 'entertainment', label: 'Entertainment', icon: 'Music', color: '#6366F1' },
];
...
export const RECENT_EXPENSES = [
  {
    ...
    timeAgo: '2 hours ago',
    approvalChain: [
      { step: 1, role: 'Direct Manager', name: 'Sarah Kim', status: 'APPROVED' },
...
export const PENDING_QUEUE = [
  {
    ...
    amountOriginal: 1240.00,
    currencyOriginal: 'EUR',
    amountCompany: 1348.52,
    currencyCompany: 'USD',
    date: '2024-11-14',
    aiNote: 'No policy violations detected. This expense is 12% lower than the typical flight for this route.',
    riskScore: 'LOW',
  },
  {
    id: 'EXP-9901',
    ...
    amountCompany: 890.00,
    currencyCompany: 'USD',
    date: '2024-11-13',
    aiNote: 'Rate is within regional hotel caps. Duration matches calendar event.',
    riskScore: 'LOW',
  },
  {
    id: 'EXP-9899',
    ...
    amountOriginal: 3200.00,
    currencyOriginal: 'USD',
    amountCompany: 3200.00,
    currencyCompany: 'USD',
    date: '2024-11-12',
    aiNote: 'High amount flagged. Matches previous year subscription. Recurring expense detected.',
    riskScore: 'MEDIUM',
  },
  {
    id: 'EXP-9897',
    ...
    amountOriginal: 456.00,
    currencyOriginal: 'USD',
    amountCompany: 456.00,
    currencyCompany: 'USD',
    date: '2024-11-11',
